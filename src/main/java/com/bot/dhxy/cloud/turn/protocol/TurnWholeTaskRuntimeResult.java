...
/**
 * Typed result payload for the closed {@code WHOLE_TASK_*}
 ...
 * start/pause outcomes use {@code booleanResult}; flying-state reads use {@code enumResult}; the pre-battle timer read uses
...
public record TurnWholeTaskRuntimeResult(
        ...
        TurnExactAttemptRecoveryResetAck recoveryResetAck) {

    /** Backward-compatible full constructor before the exact-reset ACK was added. */
    public TurnWholeTaskRuntimeResult(
        ...
        this(booleanResult, enumResult, timestampMs, clearedIntentId, dialogRuntimeFact,
                pendingTransferChoice, pendingRouteOutcome, pathingSnapshot, preBattleFact,
                combatCleanupFact, null);
    }
    ...
    public TurnWholeTaskRuntimeResult(
            ...
            Long timestampMs,
            String clearedIntentId) {
        this(booleanResult, enumResult, timestampMs, clearedIntentId, null, null, null, null, null, null, null);
    }
    ...
    public TurnWholeTaskRuntimeResult(
        ...
        this(booleanResult, enumResult, timestampMs, clearedIntentId,
                dialogRuntimeFact, null, pendingRouteOutcome, null, null, null, null);
    }
    ...
    public TurnWholeTaskRuntimeResult(Boolean booleanResult, String enumResult, Long timestampMs,
                                      ...
                                      TurnPathingSnapshot pathingSnapshot) {
        this(booleanResult, enumResult, timestampMs, clearedIntentId, dialogRuntimeFact,
                null, pendingRouteOutcome, pathingSnapshot, null, null, null);
    }
}
