...
@Value
@Builder
public class CapabilityGateCloudDecision {
    ...
    static CapabilityGateCloudDecision localOnly(String localDecision, boolean localAllowed) {
        return CapabilityGateCloudDecision.builder()
    ...
    static CapabilityGateCloudDecision cloudExecuted(
            CloudDecisionResult cloudResult,
            String localDecision,
            boolean localAllowed,
            boolean cloudAllowed) {
    ...
    static CapabilityGateCloudDecision requiredFailureDeny(
            CloudDecisionResult cloudResult,
            String localDecision,
            boolean localAllowed,
            String rejectReason) {
