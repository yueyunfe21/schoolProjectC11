...
public class TextRecognizer {
     ...
     *
     * <p>All coordinates are image-local pixels. {@code x/y} represent the preferred click or
     * center point for the text block, while {@code left/top/width/height} preserve the bounding
     * rectangle. {@code score} is provider-specific confidence and may be {@code 0.0} when the
     * provider does not expose confidence.</p>
     */
     ...
     *
     * <p>The coordinates are logical game map coordinates read from the map label, not screen pixels
     * or minimap click coordinates.</p>
     */
