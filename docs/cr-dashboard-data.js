window.CR_DASHBOARD_DATA = [
  ...
  },
  {
    "id": "G078",
    "number": 78,
    "owner": "Franklin / Codex review",
    "status": "P1 源码返修与父级 review 通过，待 fresh",
    "kind": "review",
    "domain": "通用",
    "files": "通用归队协调器、天庭战后 title/地图/Tracker 仲裁、单一 PARK owner",
    "summary": "fresh title/Tracker 已改为权威；地图差异仅废弃旧腿，不再直接重接任务。待实跑验证同一暗雷继续巡逻且不重复点绿链。",
    "verification": "需复核"
  },
  {
    "id": "G077",
  ...
  },
  {
    ...
    "number": 67,
    "owner": "Codex",
    "status": "双仓编译与本地回放通过，待重启 fresh",
    "kind": "open",
    "domain": "通用",
    "files": "鬼王归队末尾 `Alt+T`、Client 本地 ROI/模板判定、Cloud 状态栅栏",
    "summary": "首轮开面板即放权；本地 `not_returned_yet.png` 命中持续 park，未命中关面板后才继续。",
    "verification": "需复核"
  },
  {
    "id": "G066",
